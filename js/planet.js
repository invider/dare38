...
var _Planet = new PlanetProto(
    ...
    "X                                                         X",
    "X   IIIISSSSSWWWWW  XXXXXXX           XXXXXXXXXX          X",
    "X       OP       X        X           X        X          X",
    "X                X        X           X        X          X",
    "X                X        XSSSSSSSSSSSX        X          X",
    "X  IIIX          X        X           X        X          X",
    "X       f  ggg       00000    X                           X",
    "X      GGGGGDDDDDD       U      U   U     X               X",
    "X      sGGGGGGGGGG    X       U                   X       X",
    "X       sGGGGGGG      UUUU            X      UU  U        X",
    "X        sGGGd               XXXX              UU         X",
    "X         daa  X           BB     UUU         X           X",
    "X       XXXXXXXXXXXX  XXXXBBBBXXXXXXXXXXXXXXXX            X",
    "X           XXXXXXXXXXX  BBBBBBB                          X",
    "XUGgsadISAWEQBDzx0 twbf XXBBf P   t  w   b                X",
